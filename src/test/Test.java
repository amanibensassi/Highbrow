...
public class Test {
    ...
    public static void main(String[] args) {
        try {
            ...
            Date date_debut = new Date("2023/11/20");
            Date date_fin = new Date("2023/11/22");

//Pour Ajout
            Chauffeur c = new Chauffeur(Region.nabeul, 53723896, 88888, "rue-kethee", "ffff", "Picturesffff", (float) 45, "eya", "somai", "eee", 1);
//Pour Modif
            Chauffeur c4 = new Chauffeur(77, Region.bizerte, 1, 88888, "rue-kethee", "ffff", "Picturesffff", (float) 455, "nom", "prenom", "eee", 1);
//PourLocation ajout 
